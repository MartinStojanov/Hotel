...
public class GuestServiceImpl implements GuestService {
    ...
    @Override
    public Guests create(String name, String surname, String EMBG, String email, boolean breakfast) {
        Guests guests = new Guests( name,  surname,  EMBG,  email,   breakfast);
    ...
    @Override
    public Guests update(Long id, String name, String surname, String EMBG, String email,  boolean breakfast) {
